...
return new class () extends Migration {
    public function up(): void
    {
        ...
        Schema::create('re_projects', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('re_features', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('re_property_features', function (Blueprint $table): void {
            $table->foreignId('property_id');
            $table->foreignId('feature_id');
        });

        Schema::create('re_project_features', function (Blueprint $table): void {
            $table->foreignId('project_id');
            $table->foreignId('feature_id');
        });

        Schema::create('re_investors', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
            $table->string('status', 60)->default('published');
            $table->timestamps();
        ...
        Schema::create('re_currencies', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('re_consults', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
        ...
        Schema::create('re_accounts', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('re_account_password_resets', function (Blueprint $table): void {
            $table->string('email')->index();
            $table->string('token')->index();
            $table->timestamp('created_at')->nullable();
        });

        Schema::create('re_account_activity_logs', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('re_packages', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
        ...
        Schema::create('re_categories', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
            $table->string('description', 400)->nullable();
            $table->string('status', 60)->default('published');
        ...
        Schema::create('re_facilities', function (Blueprint $table): void {
            $table->id();
            $table->string('name', 120);
            $table->string('icon', 60)->nullable();
            $table->string('status', 60)->default('published');
        ...
        Schema::create('re_facilities_distances', function (Blueprint $table): void {
